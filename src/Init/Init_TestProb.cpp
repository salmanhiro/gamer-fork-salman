...
// ******************************************************************
   switch ( TESTPROB_ID )
   {
      ...
      case TESTPROB_HYDRO_PARTICLE_STELLAR_STREAM :      Init_TestProb_Hydro_ParticleStellarStream();       break;
...
//    case TESTPROB_ELBDM_JEANS_INSTABILITY_PHYSICAL :   Init_TestProb_ELBDM_JeansInstabilityPhysical();    break;
      ...
      case TESTPROB_ELBDM_STREAM_HEATING_UNIFORM_GRANULE :              Init_TestProb_ELBDM_StreamHeatingUniformGranule();              break;
